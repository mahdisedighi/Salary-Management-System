...
INSERT INTO project.Employee (Full_Name, Hire_Date, Contact_Number, NationalCode, Gender)
VALUES
    ('Ali Rezaei', '2021-01-15', '09121234567', '0640221212', 'Male'),
    ('Sara Ahmadi', '2020-05-20', '09127654321', '0640221213', 'Female'),
    ('Reza Jafari', '2019-11-01', '09123456789', '0640221214', 'Male');

INSERT INTO project.Employee_Family (Personnel_ID, NationalCode, Name, Age, Relation)
VALUES
    (1, '0650112233', 'Maryam Rezaei', 20, 'Spouse'),
    (2, '0650112244', 'Ali Ahmadi', 65, 'Child'),
    (3, '0650112255', 'Mahdi Jafari', 13, 'Child');
...
INSERT INTO project.Education (Education_ID, Title, Major, Year, Institution_id, Personnel_ID)
VALUES
    (1, 'Bachelor', 'Computer Science', '2018', 1, 1),
    (2, 'Master', 'Business Administration', '2019', 2, 2),
    (3, 'PhD', 'Engineering', '2020', 3, 3);
...
INSERT INTO project.Manager (Manager_ID, NationalCode, ManagementField, Name, Contact_Number)
VALUES
    (1, '0771231122', 'IT Management', 'Hasan Mohammadi', '09131112222'),
    (2, '0773211122', 'HR Management', 'Fatemeh Karimi', '09132223333'),
    (3, '0774446677', 'Finance Management', 'Mohammad Hosseini', '09133334444');
